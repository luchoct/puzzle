...
public class BritishNineDigitsTranslator extends AbstractIntegerLanguageTranslator {
	 ...
	 */
	void appendAndWord(final StringBuilder builder, final String previousTranslation,
					   final String currentTranslatedPart) {
	 ...
	 */
	void appendGroupSeparator(final StringBuilder builder, final int lastIndex) {
		if (lastIndex == 0) {
